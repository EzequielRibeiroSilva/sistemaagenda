...
export const Package = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 22V12" />
    <path d="M12 12 4.5 7.73" />
    <path d="M12 12l7.5-4.27" />
  </svg>
);
...
export const Cog = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M11 10.27 7 3.34" /><path d="m20.66 17-1.73-1" />
    <path d="m3.34 7 1.73 1" /><path d="M14 12h8" /><path d="M2 12h2" />
...
export const WhatsApp = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M21 11.5a8.5 8.5 0 0 1-12.9 7.2L3 20l1.5-4.8A8.5 8.5 0 1 1 21 11.5z" />
    <path d="M9.2 8.9c.2-.3.4-.3.6-.3h.6c.2 0 .4.1.5.3l.7 1.7c.1.2.1.5 0 .7l-.4.6c-.1.2-.1.4 0 .6.5.9 1.2 1.7 2 2.3.2.1.4.1.6 0l.7-.4c.2-.1.5-.1.7 0l1.6.7c.2.1.3.3.3.5v.6c0 .2 0 .4-.2.6-.4.5-1.2.8-2 .6-3.1-.7-5.6-3.1-6.4-6.2-.2-.8.1-1.6.6-2z" />
  </svg>
);
...
export const ShoppingCart = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M2.05 2.05h2l2.4 11.45a2 2 0 0 0 2 1.6h9.65a2 2 0 0 0 2-1.6L22 6H6" />
  </svg>
);
...
export const Crown = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 7l4 4 5-7 5 7 4-4v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
    <path d="M5 21h14" />
  </svg>
);
...
export const ImagePlaceholder = (props: IconProps) => (
    <svg width="32" height="32" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M19 37C28.9411 37 37 28.9411 37 19C37 9.05887 28.9411 1 19 1C9.05887 1 1 9.05887 1 19C1 28.9411 9.05887 37 19 37Z" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M19 1C17.7953 9.42318 11.411 14.478 4.02944 14.9705" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M37 19C28.5768 20.2047 23.522 26.589 23.0295 33.9706" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M14.9705 4.02944C14.478 11.411 20.5768 17.7953 28.3101 19" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const Leaf = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M15.5 8.5c.3-1.8.3-3.6 0-5.5" />
        <path d="M11 12c-2.5 0-5 2.5-5 5" />
    </svg>
);
...
export const FaUser = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
