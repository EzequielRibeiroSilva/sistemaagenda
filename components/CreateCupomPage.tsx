...
const TextInput: React.FC<TextInputProps> = ({ label, placeholder, value, onChange, type = 'text', step, required = false }) => (
  <div>
...
interface CreateCupomPageProps {
...
const CreateCupomPage: React.FC<CreateCupomPageProps> = ({ setActiveView }) => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">Criar Novo Cupom</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="pt-2">
          ...
          >
            {submitting ? 'Criando...' : 'Adicionar Cupom'}
          </button>
          {setActiveView && (
            <button
              type="button"
...
export default CreateCupomPage;
